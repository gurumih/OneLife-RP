...
window.addEventListener("load", function() {
    velocidad = new  ldBar(".velocimetro2")
    motor = new ldBar(".motor2")
    gasolina = new ldBar(".combustible2")
    LoadColors()
    LoadChecks()
    UpdateChecks()
    LoadPosition()
...
var NewUser = GetSaveId('NewUserVariable') || 'yes'
