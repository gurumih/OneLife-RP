Config = {
    ...
    Config.Languages = {
      ['en'] = {
            ['emotes'] = 'Emotki',
            ['danceemotes'] = "🕺 Taneczne Emotki",
            ['propemotes'] = "📦 Rekwizyty",
            ['favoriteemotes'] = "🌟 Ulubione",
            ['favoriteinfo'] = "Wybierz emotikonę tutaj, aby ustawić go jako ulubioną.",
            ['rfavorite'] = "Usuń ulubione",
            ['prop2info'] = "❓ Emotki rekwizytów znajdują się na końcu",
            ['set'] = "Ustaw (",
            ['setboundemote'] = ") jako twoją ulubioną emotkę",
            ['newsetemote'] = "~w~ is now your bound emote, press ~g~CapsLock~w~ to use it.",
            ['cancelemote'] = "Anuluj Emotkę",
            ['cancelemoteinfo'] = "~r~X~w~ Anuluj aktualnie odtwarzaną emotkę",
            ['walkingstyles'] = "Style Chodzenia",
            ['resetdef'] = "Przywróć Domyślnie",
            ...
            ['notvalidemote'] = "Nie jest prawidłową emotką.",
            ['nocancel'] = "Brak emotki do anulowania.",
            ['maleonly'] = "Ta emotka jest tylko dla mężczyzn!",
            ['emotemenucmd'] = "Do /emotemenu for a menu.",
            ['shareemotes'] = "👫 Wspólne Emotki",
            ['shareemotesinfo'] = "Zaproś pobliską osobę do emotki",
            ...
            ['doyouwanna'] = "~y~Y~w~ aby zaakceptować, ~r~L~w~ aby odmówić (~g~",
            ['refuseemote'] = "Emotka Odrzucona.",
            ['makenearby'] = "wyślij prośbę aby odegrać emotkę",
            ['camera'] = "Wciśnij ~y~G~w~ do zrobienia zdjęcia.",
            ['makeitrain'] = "Wciśnij ~y~G~w~ do deszczu pieniędzy",
            ['pee'] = "Wciśnij ~y~G~w~ aby sikać.",
            ['spraychamp'] = "Przytrzymaj ~y~G~w~ aby rozpylać szampana",
            ['bound'] = "Zobowiązany",
            ['to'] = "do",
            ['currentlyboundemotes'] = " Aktualnie powiązane emotki:",
