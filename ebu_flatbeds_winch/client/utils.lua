...
local ESXJobs      = false         --enable ESX   default: false
local Jobs         = {'mechanic'}    --ESX job names, separated by comma
--end ESX --
...
function allowed()
    ...
    if (ESXJobs and has_value(Jobs,ESX.PlayerData.job.name)) or (not ESXJobs) then
        return true
    else
        return false
    end
