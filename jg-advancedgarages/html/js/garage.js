...
function showGarage(data) {
  ...
  if (!vehicles.length) accordionContent = "W tym garażu nie ma pojazdów.";
          ...
          <div class="accordion-body">
            <div class="mb-4">
              <div class="d-flex align-items-center">
                <div class="w-25 text-muted">paliwo</div>
              ...
              <div class="d-flex align-items-center">
                <div class="w-25 text-muted">silnik</div>
                <div class="progress flex-fill">
              ...
              <div class="d-flex align-items-center">
                <div class="w-25 text-muted">karoseria</div>
                <div class="progress flex-fill">
            ...
            ${impound ? `
              <div class="card border-danger">
                ...
                <div class="card-body">
                  ...
                  ${impound_retrievable ? `
                    <p class="text-success">Możesz odebrać swój pojazd na odcholowniku policyjnym.</p>
                  ` : `
              ...
              <div class="d-flex justify-content-between">
                ${vehGarageId === garageId || (jobGarage || gangGarage) ? 
                  `<button class="btn btn-success" onclick="garageTakeOut('${plate}', ${!!jobGarage}, ${!!gangGarage}, '${garageId.replace(/'/g, "\\'")}')">
                    ${in_garage ? "Wyciągnij" : `Return & Take Out ${returnCost !== "FREE" ? `<span class="badge bg-white text-success ms-1">${returnCost}</span>` : ""}`}
                ...
                ${(enableTransfers.betweenGarages || enableTransfers.betweenPlayers) ? `
                  <button class="btn btn-secondary" onclick="toggleShowTransfer(${i})">
                    ${enableTransfers.betweenGarages && enableTransfers.betweenPlayers ? `Przenieś do garażu lub znajomego` : enableTransfers.betweenGarages ? `Transfer to a Garage` : `Transfer to a Player`}
                  </button>
                ` : ""}
              </div>
