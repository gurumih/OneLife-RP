...
Locale.press_to_attach = 'podepnij line'
Locale.press_to_detach = 'zdejmij line'
Locale.vehicles_locked = 'Ten pojazd jest zablokowany i dlatego nie można go holować'
