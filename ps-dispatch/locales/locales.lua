Locales = {
    ...
    ['en'] = {
        ...
        ['military'] = "Wojskowy Pojazd",
        ['truck'] = "Cieżarówka",
        -- DISPATCH MESSAGES
        ['vehicleshots'] = "DriveBy",
        ['shooting'] = "Shot's Fire",
        ['melee'] = "Bójka",
        ['driveby'] = "Drive-by shooting",
        ['speeding'] = "Zbyt Szybka Jazda",
        ['autotheft'] = "Kradzież Pojazdu",
        ['persondown'] = "Ranna Osoba",
        ['storerobbery'] = "Rabunek",
        ['fleecabank'] = "Napad na Flecca",
        ['paletobank'] = "Napad na Bank Paleto",
        ['pacificbank'] = "Napad na Pacyfik Bank",
        ['prisonbreak'] = "Ucieczka z Wiezienia",
        ['vangelico'] = "Rabunek",
        ['houserobbery'] = "Rabunek Domu",
        ['drugsell'] = "Sprzedawanie Narkotyków",
        ['carjacking'] = "Kradzież Pojazdu", 
        ['vehicletheft'] = "Kradzież Pojazdu", 
        ['officerdown'] = "Officer is down",
        ['emsdown'] = "EMS Down",
        ['artgalleryrobbery'] = "Art Gallery Robbery",
        ['humanerobbery'] = "Napad na Human Labs",
        ['trainrobbery'] = "Train Robbery",
        ['vanrobbery'] = "Security Van Robbery",
        ['underground'] = "Bunker Robbery",
        ['drugboatrobbery'] = "Suspicious Boat",
        ['unionrobbery'] = "Napad na Union",
        ['carboosting'] = "Przekroczenie Predkości",
        ['yachtheist'] = "Yacht Heist In Progress",
        ['susactivity'] = "Podejrzana Działalność",
    },
