...
Config.TournamentCooldowns = 0 * 0 -- how much time inbetween tournaments | Default is set to 2 hours and 30 minutes
Config.TournamentCooldownInSeconds = 0 -- How many seconds in between each tournament Config.TournamentCooldowns | 9000 seconds in 150 minutes
