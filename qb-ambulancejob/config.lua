...
Config.Helicopter = "ms_heli" -- Helicopter model that players with the ambulance job can use
...
Config.Locations = {
    ["checking"] = {
	    [1] = vector3(312.36, -592.97, 43.28),
	    [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["stash"] = {
	    [1] = vector3(311.71, -563.96, 43.28), -- paleto
    },
    ["duty"] = {
        [1] = vector3(310.14, -594.9, 43.28),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(291.99, -585.95, 43.2, 338.35),
    ...
    ["main"] = {
        [1] = vector3(332.3, -595.69, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(314.84, -583.91, 43.41, 337.5), taken = false, model = 1631638868},
        [2] = {coords = vector4(311.11, -582.9, 44.2, 337.01), taken = false, model = 1631638868},
        [3] = {coords = vector4(307.79, -581.7, 44.2, 340.65), taken = false, model = 2117668672},
        [4] = {coords = vector4(309.22, -577.43, 44.2, 159.82), taken = false, model = 2117668672},
        [5] = {coords = vector4(313.79, -579.26, 44.2, 156.9), taken = false, model = 2117668672},
        [6] = {coords = vector4(319.4, -580.92, 44.2, 152.05), taken = false, model = -1091386327},
        [7] = {coords = vector4(324.16, -582.87, 44.2, 165.14), taken = false, model = -1091386327},
        [8] = {coords = vector4(322.62, -587.15, 44.2, 335.02), taken = false, model = -1091386327},
	--- paleto
    ...
    ["stations"] = {
        [1] = {label = "Szpital Pillbox", coords = vector4(304.27, -600.33, 43.28, 272.249)}
    },
    ["jailbeds"] = {
...
Config.AuthorizedVehicles = {
    ...
    [12] = {
        ["ms_ramambo"] = "Ram Karetka",
        ["ms_transformer"] = "Ford Transformer",
        ["ms_charger"] = "Charger",
        ["ms_explorer"] = "Explorer",
        ["ms_tundra"] = "Tundra",
        ["ambulance"] = "Karetka",
