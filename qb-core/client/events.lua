...
RegisterNetEvent('QBCore:Command:GoToMarker', function()
    ...
    if not DoesBlipExist(blipMarker) then
        QBCore.Functions.Notify('Brak ustawionych punktów orientacyjnych.', "error",5000)
        return 'marker'
    end
    ...
    if not found then
        ...
        QBCore.Functions.Notify('Błąd podczas teleportacji.', "error",5000)
    end

    -- If Z coord was found, set coords in found coords.
    SetPedCoordsKeepVehicle(ped, x, y, groundZ)
    QBCore.Functions.Notify('Teleportowany do punktu nawigacyjnego.', "success",5000)
end)
