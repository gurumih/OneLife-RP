...
RegisterNetEvent('qb-bossmenu:client:OpenMenu', function()
    ...
    local bossMenu = {
        ...
        },
        {
            ...
            txt = "Sprawdź swoją listę pracowników",
        ...
        {
            header = "Zatrudnij pracowników",
            txt = "Zatrudnij pobliskich cywilów",
        ...
        {
            header = "Dostęp do pamięci",
            txt = "Dostęp do pamięci",
