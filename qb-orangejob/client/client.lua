...
Citizen.CreateThread(function()
	...
	local s1d7 = false
	if dist <= 2.0 then
	DrawText3D2(procesX, procesY, procesZ+0.1, "[E] Zrób sok pomarańczowy")
		...
		QBCore.Functions.Notify('Nie masz pomarańczy...', 'error')
		end
		end	
	end
...
function SellKurczaki22()
    ...
    if(count == 0) then
    QBCore.Functions.Progressbar("search_register", "Przetwarzanie..", 5000, false, true, {disableMovement = true,
