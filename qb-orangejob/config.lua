...
Config.textDel = '(~g~[E]~w~) zacznij pracę.(~g~[lpm]~w~)zbieranie pomarańczy.(~g~[Backspace]~w~) zakonczenie pracy. '

Strings = {
   
    ['someone_close'] = 'Gracz jest zbyt blisko ciebie!',
    ['orange'] = 'Zbieranie pomarańczy',
    ['process'] = 'przetwarzanie pomarańczy',
