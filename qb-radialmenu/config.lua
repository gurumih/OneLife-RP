...
Config.JobInteractions = {
    ...
    ["tow"] = {
        {
            ...
            id = 'towvehicle',
            title = 'Wciągnij pojazd na Lawete',
            icon = 'truck-pickup',
            type = 'client',
    ...
    ["hotdog"] = {
        {
            id = 'togglesell',
            title = 'Rozpocznij/Zakończ Sprzedawać',
            icon = 'hotdog',
            type = 'client',
            event = 'qb-hotdogjob:client:ToggleSell',
            shouldClose = true
