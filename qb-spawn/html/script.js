...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Gdzie chcesz się obudzić?"><p><span id="null">Gdzie chcesz się obudzić?</span></p></div>')
    
    setTimeout(function(){
        $(parent).append('<div class="location" id="location" data-location="current" data-type="current" data-label="Ostatnia Lokalizacja"><p><span id="current-location">Ostatnia Lokalizacja</span></p></div>');
